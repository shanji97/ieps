import sys
from implementation_extraction import regularni_izrazi, xpath

extraction_algorithm = sys.argv[1]

rtv_page_1 = open("pages/rtvslo.si/Audi A6 50 TDI quattro_ nemir v premijskem razredu - RTVSLO.si.html").read()
rtv_page_2 = open("pages/rtvslo.si/Volvo XC 40 D4 AWD momentum_ suvereno med najboljše v razredu - RTVSLO.si.html").read()
...
studentska_prehrana_page_1 = open("pages/studentska-prehrana.si/- Študentska prehrana.html").read()
